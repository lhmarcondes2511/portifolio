...
namespace MyCurriculum.Controllers
{
    public class LanguagesController : Controller
    {
        ...
        public LanguagesController(MyCurriculumContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,LinkImage,Name,Percent,Text")] Language language)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LinkImage,Name,Percent,Text")] Language language)
        {
            if (id != language.Id)
            {
                return NotFound();
